    ...
    static void functions(Accounts acc, Accounts[] arr){
        ...
        if(acc.getAccountType().equals("Savings") || acc.getAccountType().equals("Joint")){
            ...
            while(command>0 && command<3){
                ...
                else if(command == 2) CheckBalance.getBalance(acc);
...
public class ATM {
    ...
    public static void main(String[] args){
        ...
        acc_arr[0].setAccount("12345", "43232", 10000, "Savings");
        acc_arr[1].setAccount("23412", "12390", 50000, "Joint");
        acc_arr[2].setAccount("09870", "08789", 100, "Children");
